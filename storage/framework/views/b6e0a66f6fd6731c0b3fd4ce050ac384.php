          ...
          <div x-data="{open:false}" class="relative ml-3">
            ...
            <div x-show="open" x-on:click.outside="open=false" class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
              ...
              <?php if(Route::has('login')): ?>
                    ...
                    <a href="<?php echo e(url('/dashboard')); ?>" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-0">Dashboard</a>
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-1">login</a>

                        <?php if(Route::has('register')): ?>
                        <a href="<?php echo e(route('register')); ?>" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-2">Register</a>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
...
<?php /**PATH D:\LARAVEL\integrator\resources\views/livewire/navigation.blade.php ENDPATH**/ ?>