...
} elseif ($_instance->childHasBeenRendered('kojxgmk')) {
    $componentId = $_instance->getRenderedChildComponentId('kojxgmk');
    $componentTag = $_instance->getRenderedChildComponentTagName('kojxgmk');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('kojxgmk');
} else {
    $response = \Livewire\Livewire::mount('navigation');
    $html = $response->html();
    $_instance->logRenderedChild('kojxgmk', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH D:\integrator\resources\views/layouts/index.blade.php ENDPATH**/ ?>